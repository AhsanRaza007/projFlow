...
const ProjectForm: React.FC<{
    ...
    return (
        <LocalizationProvider dateAdapter={AdapterDayjs}>
            <Box display={"flex"} flexDirection={"column"} gap={2} component="form" onSubmit={handleSubmit(onSubmit)}>
                <TextFieldWithTooltip control={control} name="name" rules={{ required: "Project Name is required" }} label="Project Name" />
