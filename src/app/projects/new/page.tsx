...
const ProjectCreatePage = () => {
    ...
    const handleSubmit = async (projectData: ProjectCreate) => {
        ...
        try {
            ...
            router.push("/projects"); // Navigate to the project list page after successful creation
        } catch (err: unknown) {
    ...
    return (
        <Box>
            ...
            <Box marginTop={4}>
                <ProjectForm onSubmit={(data) => handleSubmit(data as ProjectCreate)} onBackBtnClick={handleBackBtnClick} submitButtonText="Create Project" />
            </Box>
            {submittingError && (
